...
namespace Shop.Infrastructure.Migrations
{
    ...
    [Migration("20241027073041_Init_ShippingMethod")]
    partial class Init_ShippingMethod
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.Domain.ProuductAgg.Product", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Shop.Domain.ProuductAgg.Product", b =>
                {
                    ...
                    b.OwnsMany("Shop.Domain.ProuductAgg.ProductImage", "Images", b1 =>
                        {
                            b1.Property<long>("ProductId")
                                .HasColumnType("bigint");
                    ...
                    b.OwnsMany("Shop.Domain.ProuductAgg.ProductSpecification", "Specifications", b1 =>
                        {
                            b1.Property<long>("ProductId")
                                .HasColumnType("bigint");
