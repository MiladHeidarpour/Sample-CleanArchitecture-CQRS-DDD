...
namespace Common.Domain.Utilities
{
    ...
    {
        //public static string GenerateUnitText(IFromFile fileInput)
        //{
        //    return Guid.NewGuid()+DateTime.Now.TimeOfDay.ToString().Replace(":","").Replace(".",""+Path.GetExtension(fileInput.FileName));
        //}
